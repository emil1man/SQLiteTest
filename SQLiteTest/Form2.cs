...
namespace SQLiteTest
{
    public partial class Form2 : Form
    {
        ...
        {
            // TODO: данная строка кода позволяет загрузить данные в таблицу "companyBD.СуммаЗП". При необходимости она может быть перемещена или удалена.
            this.СуммаЗПTableAdapter.Fill(this.companyBD.СуммаЗП);
